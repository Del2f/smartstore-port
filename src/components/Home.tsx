...
import Swiper_large from "./Swiper_large";
...
import "./flex.css";
import "./Home.css";
import { Gift, InfoCircle, ArrowClockwise, Truck, ExclamationCircle } from "react-bootstrap-icons";
                      ...
                      <div className="salestats">
                        ...
                        <ul className="panel-list">
                          ...
                          <li className="text-box">
                            ...
                            <InfoCircle className="info-title-icon"/>
                            <li className="number-area">
                ...
                <div className="panel panel-dashboard">
                  <div className="panel-heading">
                    ...
                    <div className="border-list-wrap flex-col-6 flex-col-sm-6 flex-col-xs-12">
                        <ul className="panel-border-list">
                          <li className="clearfix">
                            <span className="info-title">이번달 등급 <InfoCircle className="info-title-icon"/>
                            </span>
                            <span className="number-area">
                          ...
                          <li className="clearfix">
                            <span className="info-title">굿 서비스 기준 <InfoCircle className="info-title-icon"/>
                            </span>
                            <span className="number-area">
                      ...
                      <ul className="panel-border-list">
                          <li className="clearfix">
                            <span className="info-title">판매 페널티 <InfoCircle className="info-title-icon"/>
                            </span>
                            <span className="number-area">
                          ...
                          <li className="clearfix">
                            <span className="info-title">제재 단계 <InfoCircle className="info-title-icon"/>
                            </span>
                            <span className="number-area">
